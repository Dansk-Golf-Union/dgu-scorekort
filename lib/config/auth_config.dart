class AuthConfig {
  ...
  static const String redirectUri = 'https://staging-danskgolfunion.dk.sdmdev.dk/verifiedlogin';
  
  // GolfBox Auth endpoints
  static const String authBaseUrl = 'https://auth.golfbox.io';
  
  // API endpoints
  static const String apiBaseUrl = 'https://dgubasen.api.union.golfbox.io/info@ingeniumgolf.dk/clubs';
